...
export const AssistantOrb: React.FC<AssistantOrbProps> = ({
  ...
  return (
    <div className="relative flex items-center justify-center w-[720px] h-[720px] max-w-full select-none">
      {/* Background Large Minimalist Cinematic Typography: शाश्वत */}
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-0">
        <h1 className="text-[120px] sm:text-[160px] md:text-[210px] font-extrabold tracking-[0.2em] font-sans select-none bg-gradient-to-b from-white/14 via-white/5 to-transparent bg-clip-text text-transparent opacity-15 filter blur-[0.5px]">
          शाश्वत
        </h1>
      </div>
